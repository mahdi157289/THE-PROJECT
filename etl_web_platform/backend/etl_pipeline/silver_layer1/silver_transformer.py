...
# Fix import paths for the new structure
current_file = os.path.abspath(__file__)
silver_layer_dir = os.path.dirname(current_file)
etl_pipeline_dir = os.path.dirname(silver_layer_dir)
backend_dir = os.path.dirname(etl_pipeline_dir)

# Add paths to sys.path
sys.path.insert(0, etl_pipeline_dir)
sys.path.insert(0, os.path.join(etl_pipeline_dir, 'config'))
sys.path.insert(0, os.path.join(etl_pipeline_dir, 'utils'))

from config.settings import PATHS
from utils.db_connection import DatabaseConnector
from silver_layer1.data_cleaner import DataCleaner
from silver_layer1.data_transformer import DataTransformer
from silver_layer1.data_saver import DataSaver
from silver_layer1.schemas import get_silver_cotations_schema, get_silver_indices_schema, get_rejected_schema, get_rejected_prime_schema
from silver_layer1.models import RejectedRecord
