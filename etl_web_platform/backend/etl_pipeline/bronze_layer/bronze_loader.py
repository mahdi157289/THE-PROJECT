...
# Add the root project config directory to Python path
project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', '..', '..', 'medallion_etl_project'))
config_path = os.path.join(project_root, 'config')
if config_path not in sys.path:
    sys.path.insert(0, config_path)

# Use existing config from root project
...
class BronzeLevelLoader:
    ...
    def load_bronze_data(self):
        ...
        try:
            ...
            # Read cotations CSV
            cotations_path = os.path.join(os.path.dirname(__file__), '..', '..', 'data', 'input', 'cotations', 'cotations.csv')
            ...
            # Read indices CSV
            indices_path = os.path.join(os.path.dirname(__file__), '..', '..', 'data', 'input', 'indices', 'indices.csv')
