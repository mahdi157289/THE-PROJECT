...
from golden_saver import GoldenDataSaver
from statistical_validation import validate_cotations , validate_indices

from golden_features_creation import SectorClassifier ,enhance_cotations,enhance_indices
...
class GoldenLayer:
    ...
    def process(self, cotations: pd.DataFrame, indices: pd.DataFrame) -> tuple:
        ...
        try:
            golden_cotations = enhance_cotations(cotations, sector_indices)
            golden_indices = enhance_indices(indices)
        ...
        try:
            val_cotations = validate_cotations(golden_cotations, sector_indices)
            val_indices = validate_indices(golden_indices)
